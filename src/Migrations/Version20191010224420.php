 ...
 */
final class Version20191010224420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD travel_date DATE NOT NULL, ADD travel_time TIME NOT NULL, ADD comment LONGTEXT DEFAULT NULL, ADD currency VARCHAR(255) NOT NULL, ADD campaign JSON DEFAULT NULL, CHANGE price price DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP travel_date, DROP travel_time, DROP comment, DROP currency, DROP campaign, CHANGE price price DOUBLE PRECISION DEFAULT \'NULL\'');
